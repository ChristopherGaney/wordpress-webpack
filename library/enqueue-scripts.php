...
function html5blank_styles() {
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/dist/assets/css/app.css', array(), '1.0', 'all');
...
function html5blank_scripts() {
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscript', get_template_directory_uri() . '/dist/assets/js/app.js', array(), '1.0.0', true); 
