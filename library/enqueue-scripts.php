...
function html5blank_header_scripts() {
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/dist/assets/js/app.min.js', array('jquery'), '1.0.0', true); 

         // localize ajax vars
        wp_localize_script( 'html5blankscripts', 'url_for_ajax', array( 'ajax_url' => admin_url( 'admin-ajax.php' ), 'ajax_nonce' => wp_create_nonce('my_secret_nonce')));
